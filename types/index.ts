...
// Added KycStatus type
export type KycStatus = 'UNVERIFIED' | 'PENDING' | 'VERIFIED' | 'REJECTED';
// Added kycStatus to User interface
export interface User { id: string; email: string; name: string; avatar?: string; role: UserRole; balance: number; totalInvested: number; totalWithdrawn: number; referralCode: string; referredBy?: string; createdAt: number; isBlocked: boolean; kycLevel: 0 | 1 | 2; kycStatus: KycStatus; twoFactorEnabled: boolean; }
