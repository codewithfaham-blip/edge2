...
import { MessageSquare, Send, X, Bot, User, Loader2, Minus, Maximize2, ShieldCheck, Wallet, ArrowDownCircle, Cpu } from 'lucide-react';
...
export const AIAgent: React.FC = () => {
  const { currentUser, investments, plans, transactions } = useApp();
  ...
  const handleSendMessage = async (customInput?: string) => {
    ...
    try {
      // Per instructions, create a new instance right before use
